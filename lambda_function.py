...
def lambda_handler(event, context):
    ...
    bucket_name = 'marketing-email-template-001' # Replace with your bucket name
    ...
    try:
        ...
        for contact in contacts:
            ...
            response = ses_client.send_email(
                Source='spha.xtrader@gmail.com',  # Replace with your verified "From" address
                Destination={'ToAddresses': [contact['Email']]},
                Message={
                    'Subject': {'Data': 'Special Offer Inside!', 'Charset': 'UTF-8'},
